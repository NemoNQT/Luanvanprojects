...
<a href="/luanvan/hosomotcua/addLHS"> Thêm loại hồ sơ</a>
	...
	<table class="table table-striped table-bordered table-hover">
		...
		<tbody>
			...
			%>
			<tr>
				<td><%=loaihoso.getMaLHS()%></td>
				<td><%=loaihoso.getTenLHS()%></td>
				<td><%=loaihoso.getTrangthaiLHS()%></td>
				 ...
				 <td><a href="/luanvan/hosomotcua/viewLHS/<%=loaihoso.getId()%>" >Hien thi</a></td>
				 
				<!--   <td><a href="/luanvan/hosomotcua/createHS/<%=loaihoso.getId()%>" >Tao HS</a></td>
				 	-->
			</tr>
			<%}%>
