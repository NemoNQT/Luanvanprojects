...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <li class="nav navbar-form"><a href="/luanvan/user/gioithieu">GIỚI THIỆU<span class="sr-only">(current)</span></a></li>
            <li class="nav navbar-form"><a href="/luanvan/user/thutuchanhchinh">THỦ TỤC HÀNH CHÍNH<span class="sr-only">(current)</span></a></li>
      <li class="nav navbar-form"><a href="/luanvan/user/huongdan">HƯỚNG DẪN NỘP HỒ SƠ<span class="sr-only">(current)</span></a></li>
      <li class="nav navbar-form"><a href="/luanvan/user/thongke"> THỐNG KÊ DỊCH VỤ CÔNG<span class="sr-only">(current)</span></a></li>
        </ul>
  <!--      <form class="navbar-form navbar-left">
       ...
       <li><a  href="/luanvan/user/dangky" class="btn btn-primary btn-lg">
          <span class="glyphicon glyphicon-user"></span> Đăng Ký
        </a></li>
      </ul>
      <ul class="nav navbar-form navbar-right">
        <li><a  href="/luanvan/user/dangnhap" class="btn btn-primary btn-lg">
         ...
         <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Dropdown <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="/luanvan/user/list">Danh Sách Người Dùng</a></li>
